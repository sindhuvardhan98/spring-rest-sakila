...
@Component
public class FilmDetailsRepresentationModelAssembler extends RepresentationModelAssemblerSupport<
        FilmDetailsDto.FilmDetails, FilmDetailsDto.FilmDetailsResponse> {
