...
@Component
public class ActorDetailsRepresentationModelAssembler extends RepresentationModelAssemblerSupport<
        ActorDetailsDto.ActorDetails, ActorDetailsDto.ActorDetailsResponse> {
