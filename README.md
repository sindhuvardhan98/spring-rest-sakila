...
API references are generated by Asciidoctor in Spring REST Docs and are provided as `/api/v1/docs/index.html` in application.

### OpenAPI/Swagger

The OpenAPI specification file `openapi3.yaml` can be rendered using the Swagger UI. The specification is generated by Spring REST Docs and is provided under the path `/api/v1/docs`.

### Postman

The Postman collection file `postman-collection.json` contains the endpoints and examples of requests and responses. The collection generated by Spring REST Docs is provided under the path `/api/v1/docs`.
